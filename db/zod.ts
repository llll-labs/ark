...
export const marketJobUpsertSchema = z.object({
  ...
  sectionRole: z.string().max(8000).optional(),
  sectionDo: z.string().max(8000).optional(),
  sectionKnow: z.string().max(8000).optional(),
  sectionCompany: z.string().max(8000).optional(),
